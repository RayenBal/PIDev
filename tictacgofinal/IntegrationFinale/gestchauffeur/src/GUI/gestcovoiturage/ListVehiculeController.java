...
private void searchButtonClicked(ActionEvent event) {
    String searchQuery = searchLabel.getText();
    try {
        List<Vehicule> searchResult = serviceVehicule.searchVehicule(searchQuery);
        ListVehicules.getItems().clear();
        ListVehicules.getItems().addAll(searchResult);
    } catch (SQLException ex) {
        Logger.getLogger(ListVehiculeController.class.getName()).log(Level.SEVERE, null, ex);
    }
}
