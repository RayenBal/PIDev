...
public class SignInController implements Initializable {
    ...
    void TestLogin(ActionEvent event) throws SQLException, IOException {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/gestchauffeur/SignInChauffeur.fxml"));
            Parent root = loader.load();
            label.getScene().setRoot(root);
        } catch (IOException ex) {
            Logger.getLogger(SignInChauffeurController.class.getName()).log(Level.SEVERE, null, ex);
        }
         System.out.println("chauffeur");
               } else if (userType.equals("passager")) {
                   
        // L'utilisateur est un passager, rediriger vers la page de passager
         try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/gestpassager/SignInPassager.fxml"));
            Parent root = loader.load();
            label.getScene().setRoot(root);
        } catch (IOException ex) {
            Logger.getLogger(SignInPassagerController.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("Testback.fxml"));
            Parent root = loader.load();
            label.getScene().setRoot(root);
        } catch (IOException ex) {
            Logger.getLogger(SignInChauffeurController.class.getName()).log(Level.SEVERE, null, ex);
